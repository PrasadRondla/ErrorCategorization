...
:BUILD_JOB
SET buildNumber=%1
SET buildURL= "http://10.222.128.33:8080/job/RMS/job/Qapter_Sections/"%buildNumber%"/consoleText"
SET buildDetails=Build_%buildNumber%
GOTO NEXTSTEPS
:LASTBUILD
SET buildURL= "http://10.222.128.33:8080/job/RMS/job/Qapter_Sections/lastBuild/consoleText"
...
curl -o %buildDetails% --user "Infosys":"Infy@2021" %buildURL%
